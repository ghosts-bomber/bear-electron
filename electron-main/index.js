...
var createWindow = function () {
    var win = new electron_1.BrowserWindow({
        webPreferences: {
            ...
            preload: path_1.default.join(__dirname, "./preload.js"), // 需要引用js文件
        },
    });
    // 如果打包了，渲染index.html
    if (process.env.NODE_ENV !== 'development') {
        ...
        var url = "http://localhost:5173"; // 本地启动的vue项目路径。注意：vite版本3以上使用的端   口5173；版本2用的是3000
        win.loadURL(url);
        win.webContents.openDevTools();
    }
};
...
electron_1.ipcMain.handle("read-file", function (event, filePath) { return __awaiter(void 0, void 0, void 0, function () {
    var data, error_1;
...
electron_1.ipcMain.handle("select-file", function () { return __awaiter(void 0, void 0, void 0, function () {
    var result, filePath, content, stats, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
            ...
            case 4: return [2 /*return*/, { success: false, message: "用户取消选择文件" }];
            case 5:
                error_2 = _a.sent();
                console.error("文件选择或读取错误:", error_2);
